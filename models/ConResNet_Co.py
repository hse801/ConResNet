...
class CoConNet(nn.Module):
    ...
    def forward(self, x_list):
        ...
        # print(f'af fusionConv x = {x.size()}')
        # af fusionConv x = torch.Size([1, 64, 10, 16, 20])
        ...
        # x_1 = x_1.unsqueeze(1)
        #
        # # print(f'x0 = {x_0.size()}, x1 = {x_1.size()}')
        # # x0 = torch.Size([1, 1, 80, 128, 160]), x1 = torch.Size([1, 1, 80, 128, 160])
        #
        # # Encoder
        # x_0 = self.conv_4_32(x_0)
        # x_1 = self.conv_4_32_2(x_1)
        #
        # x_0 = self.layer0(x_0)
        # x_1 = self.layer0(x_1)
        # skip1 = x_0 + x_1
        ...
        #
        # x_0 = self.conv_32_64(x_0)
        # # print(f'self.conv_32_64_2(x_1) = {self.conv_32_64_2(x_1).size()}, x_1 = {x_1.size()}')
        # x_1 = self.conv_32_64_2(x_1)
        # # print(f'self.conv_32_64_2(x_1) = {self.conv_32_64_2(x_1).size()}, x_1 = {x_1.size()}')
        #
        # x_0 = self.layer1(x_0)
        # x_1 = self.layer1(x_1)
        ...
        # print(f'skip2 = {skip2.size()}')
        # # skip2 = torch.cat([x_0, x_1], dim=1)
        # # skip2 = torch.Size([1, 32, 80, 128, 160])
        #
        # x_0 = self.conv_64_128(x_0)
        # x_1 = self.conv_64_128_2(x_1)
        #
        # x_0 = self.layer2(x_0)
        # x_1 = self.layer2(x_1)
        # skip3 = x_0 + x_1
        # print(f'skip3 = {skip3.size()}')
        # # skip3 = torch.cat([x_0, x_1], dim=1)
        # # skip3 = torch.Size([1, 32, 80, 128, 160])
        #
        # x_0 = self.conv_128_256(x_0)
        # x_1 = self.conv_128_256_2(x_1)
        #
        # x_0 = self.layer3(x_0)
        # x_1 = self.layer3(x_1)
        #
...
def ConResNet_Co(shape, num_classes=2, weight_std=True):
